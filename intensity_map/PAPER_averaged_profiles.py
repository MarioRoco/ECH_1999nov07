...
ax.set_title(f'SUMER spectrum of the CH uncorrected and corrected with HRTS', fontsize=18)
ax.set_ylabel(r'Spectral radiance (W m$^{-2}$ sr$^{-1}$ nm$^{-1}$)', fontsize=15)
ax.legend(fontsize=11)
ax.set_xlabel('Doppler shift (km/s)', fontsize=14) #'Wavelength (nm)'
ax.set_xlim(x_lims)
plt.tight_layout()
...
ax[0].set_title(f'SUMER spectrum uncorrected, multigaussian fit', fontsize=18)
...
for n_gauss in range(N_gaussians):
    ...
    ax[0].plot(x_fit_corrected_qra_singlegauss, y_fit_corrected_qra_singlegauss, color=color_i, linestyle=':')#, label='Individual gaussians')
ax[0].plot([], [], color='grey', linestyle=':', label='Individual gaussians')

ax[0].axvline(x=0, color='black', linestyle='--', label='Ne VIII/2')
ax[0].axvspan(-v_unc_0, v_unc_0, color='grey', alpha=0.15)
ax[0].set_title(f'SUMER spectrum corrected with HRTS QS-A, multigaussian fit', fontsize=18)
#ax[0].set_title(f'SUMER {range_percentage}%, corrected', fontsize=18)
ax[0].set_ylabel(r'Spectral radiance (W m$^{-2}$ sr$^{-1}$ nm$^{-1}$)', fontsize=15)
ax[0].legend(fontsize=12)
ax[0].set_yscale('linear')
...
for n_gauss in range(N_gaussians):
    ...
    ax[0].plot(x_fit_corrected_qrb_singlegauss, y_fit_corrected_qrb_singlegauss, color=color_i, linestyle=':')#, label='Individual gaussians')
ax[0].plot([], [], color='grey', linestyle=':', label='Individual gaussians')

ax[0].axvline(x=0, color='black', linestyle='--', label='Ne VIII/2')
ax[0].axvspan(-v_unc_0, v_unc_0, color='grey', alpha=0.15)
ax[0].set_title(f'SUMER spectrum corrected with HRTS QS-B, multigaussian fit', fontsize=18)
#ax[0].set_title(f'SUMER {range_percentage}%, corrected', fontsize=18)
ax[0].set_ylabel(r'Spectral radiance (W m$^{-2}$ sr$^{-1}$ nm$^{-1}$)', fontsize=15)
ax[0].legend(fontsize=12)
ax[0].set_yscale('linear')
...
for n_gauss in range(N_gaussians):
    ...
    ax[0].plot(x_fit_corrected_qrl_singlegauss, y_fit_corrected_qrl_singlegauss, color=color_i, linestyle=':')#, label='Individual gaussians')
ax[0].plot([], [], color='grey', linestyle=':', label='Individual gaussians')

ax[0].axvline(x=0, color='black', linestyle='--', label='Ne VIII/2')
ax[0].axvspan(-v_unc_0, v_unc_0, color='grey', alpha=0.15)
ax[0].set_title(f'SUMER spectrum corrected with HRTS QS-L, multigaussian fit', fontsize=18)
#ax[0].set_title(f'SUMER {range_percentage}%, corrected', fontsize=18)
ax[0].set_ylabel(r'Spectral radiance (W m$^{-2}$ sr$^{-1}$ nm$^{-1}$)', fontsize=15)
ax[0].legend(fontsize=12)
ax[0].set_yscale('linear')
