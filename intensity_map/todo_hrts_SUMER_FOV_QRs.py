"""
This script plots the EIT full Sun image with the contours of the coronal hole and the  SUMER FOV.  
"""
...
eit_time = 'early' #'early' or 'late' (early: around 1 or 4 am; late: around 6 or 7 am)
vmin_eit, vmax_eit = 5.5e1, 5e3 
contour_intensity_eit_fullsun = 135. #110.
min_contour_points = 500  # Define a threshold for minimum contour size (number of points)b# Adjust this based on what "small" means for your case
...
###TODO:
ID, Distance from Solar Limb (arcsec), Distance from Solar Limb (cos 0)
QR A  584"-780"  0.92-0.98
QR B  224 -276   0.65-0.70
QR L  13-19      0.17-0.20
QR    460-478    0.85-0.86

Stellarium: 1978 February 13: 1391400, 0.987au, 149.697 mkm, 32'23.13''
...
R_sun = header_eit['RSUN_ARC'] #[arcsec] apparent photospheric solar radius

# qqr_a
from hrts_spectra.data__qqr_a_xdr import lambda__qqr_a_xdr, radiance__qqr_a_xdr, unc_radiance__qqr_a_xdr
lam_hrtsa, rad_hrtsa = lambda__qqr_a_xdr, radiance__qqr_a_xdr
hrtsa_description = r'QR-A close to the disk center ($\cos \theta = 0.92 - 0.98$)'
R_QRa_in = R_sun*(1-0.98)
R_QRa_out = R_sun*(1-0.92)
# qqr_b
from hrts_spectra.data__qqr_b_xdr import lambda__qqr_b_xdr, radiance__qqr_b_xdr, unc_radiance__qqr_b_xdr
lam_hrtsb, rad_hrtsb = lambda__qqr_b_xdr, radiance__qqr_b_xdr
hrtsb_description = r'QR-B ($\cos \theta \sim 0.68$)'
R_QRb = R_sun*(1-0.68)
# qqr_l
from hrts_spectra.data__qqr_l_xdr import lambda__qqr_l_xdr, radiance__qqr_l_xdr, unc_radiance__qqr_l_xdr
lam_hrtsl, rad_hrtsl = lambda__qqr_l_xdr, radiance__qqr_l_xdr
hrtsl_description = r'QR-L close to the solar limb ($\cos \theta \sim 0.18$)'
R_QRl = R_sun*(1-0.18)
"""
# qr
from hrts_spectra.data__qr_xdr import lambda__qr_xdr, radiance__qr_xdr, unc_radiance__qr_xdr
lam_hrtsqr, rad_hrtsqr = lambda__qr_xdr, radiance__qr_xdr
hrtsqr_description = r'QR'
"""
