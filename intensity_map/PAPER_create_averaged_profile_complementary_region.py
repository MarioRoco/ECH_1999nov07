...
folder_name = '../outputs/paper_figures/complementary_contours/v4' #name of the folder where you save the images
...
ax.axvspan(-v_unc_0, v_unc_0, color='grey', alpha=0.15)
#ax.set_title(f'SUMER spectrum of the CH uncorrected and corrected with HRTS', fontsize=title_size)
#ax.set_title(f'CH-3', fontsize=title_size)
ax.set_ylabel(r'Spectral radiance (W m$^{-2}$ sr$^{-1}$ ''\u212B'r'$^{-1}$)', fontsize=axislabel_size)
#ax.legend(fontsize=legend_size)
ax.set_xlabel('Doppler shift (km/s)', fontsize=axislabel_size) 
ax.set_xlim(x_lims)
...
ax.text(
    ...
    'CH-3',    # your text (multiline if you want)
    ...
    fontweight='bold', color='black')#, color=color_contours_eit_Imap)#color=(0.83, 0.70, 0.00)
# legend in desired order:
handles, labels = ax.get_legend_handles_labels()
order = [
    labels.index('SUMER uncorrected'),
...
ax[0].set_title(f'CH-3 uncorrected', fontsize=title_size)
...
ax[0].set_title(f'CH-3 corrected with QS-A', fontsize=title_size)
ax[0].set_ylim(y_lims_fit)
ax[1].axhline(y=0, linestyle=':', color='black')
#ax[0].set_title(f'SUMER corrected', fontsize=title_size)
ax[0].set_ylabel(r'Spectral radiance (W m$^{-2}$ sr$^{-1}$ ''\u212B'r'$^{-1}$)', fontsize=axislabel_size)
...
ax[0].set_title(f'CH-3 corrected with QS-B', fontsize=title_size)
ax[0].set_ylim(y_lims_fit)
ax[1].axhline(y=0, linestyle=':', color='black')
#ax[0].set_title(f'SUMER corrected', fontsize=title_size)
ax[0].set_ylabel(r'Spectral radiance (W m$^{-2}$ sr$^{-1}$ ''\u212B'r'$^{-1}$)', fontsize=axislabel_size)
