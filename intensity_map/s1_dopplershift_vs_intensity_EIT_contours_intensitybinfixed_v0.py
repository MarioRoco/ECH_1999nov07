...
######################################################
# Bins logarythmically equispaced

if range_percentage_list == 'log':
	Imin = np.min(data_eit_crop_corrected)
	Imax = np.max(data_eit_crop_corrected)
	N = 10          # number of bins

	# Log‑spaced bins in physical units
	bins_phys = np.logspace(np.log10(Imin), np.log10(Imax), N+1)
	# Log‑spaced bins as percentage of Imax
	bins_pct = 100 * bins_phys / Imax

	# For percentage of Imax
	range_percentage_list  = [[bins_pct[i],  bins_pct[i+1]]  for i in range(len(bins_pct)-1)]
...
for range_percentage_i in range_percentage_list:
	...
	if len(rowscols_croplat_sumer_from_eit)!=0:
		...
		bound_mean_list.append((upper_bound_eit+lower_bound_eit)/2.)
		bound_unc_list.append((upper_bound_eit-lower_bound_eit)/2.)
...
ax[0].errorbar(x=bound_mean_list-x_shift_errorbars_intensity, xerr=bound_unc_list, y=y_intensity_correction_qra, yerr=yerr_intensity_correction_qra, color='blue', linewidth=0., elinewidth=1.0, marker='.', label='SUMER corrected, QR-A')
ax[0].errorbar(x=bound_mean_list+x_shift_errorbars_intensity, xerr=bound_unc_list, y=y_intensity_correction_qrb, yerr=yerr_intensity_correction_qrb, color='red', linewidth=0., elinewidth=1.0, marker='.', label='SUMER corrected, QR-B')
...
ax[1].errorbar(x=bound_mean_list-x_shift_errorbars_intensity, xerr=bound_unc_list, y=v_peak_corrected_qra_list, yerr=ev_peak_corrected_qra_list, color='blue', linewidth=0., elinewidth=1.0, marker='.', label='SUMER corrected, QR-A')
ax[1].errorbar(x=bound_mean_list+x_shift_errorbars_intensity, xerr=bound_unc_list, y=v_peak_corrected_qrb_list, yerr=ev_peak_corrected_qrb_list, color='red', linewidth=0., elinewidth=1.0, marker='.', label='SUMER corrected, QR-B')
...
ax[0].errorbar(x=percentage_list+x_shift_errorbars_percentage, xerr=percentage_unc_list, y=y_intensity_correction_qrb, yerr=yerr_intensity_correction_qrb, color='red', linewidth=0., elinewidth=1.0, marker='.', label='SUMER corrected, QR-B')
...
ax[1].errorbar(x=percentage_list-x_shift_errorbars_percentage, xerr=percentage_unc_list, y=v_peak_corrected_qra_list, yerr=ev_peak_corrected_qra_list, color='blue', linewidth=0., elinewidth=1.0, marker='.', label='SUMER corrected, QR-A')
ax[1].errorbar(x=percentage_list+x_shift_errorbars_percentage, xerr=percentage_unc_list, y=v_peak_corrected_qrb_list, yerr=ev_peak_corrected_qrb_list, color='red', linewidth=0., elinewidth=1.0, marker='.', label='SUMER corrected, QR-B')
...
fig, ax = plt.subplots(nrows=2, ncols=1, figsize=(12, 8), gridspec_kw={'height_ratios': [1, 1.5]}, sharex=True)
ax[0].errorbar(x=percentage_list-x_shift_errorbars_percentage_log, xerr=percentage_unc_list, y=y_intensity_correction_qra, yerr=yerr_intensity_correction_qra, color='blue', linewidth=0., elinewidth=1.0, marker='.', label='SUMER corrected, QR-A')
ax[0].errorbar(x=percentage_list+x_shift_errorbars_percentage_log, xerr=percentage_unc_list, y=y_intensity_correction_qrb, yerr=yerr_intensity_correction_qrb, color='red', linewidth=0., elinewidth=1.0, marker='.', label='SUMER corrected, QR-B')
#ax[0].errorbar(x=percentage_list, xerr=percentage_unc_list, y=y_intensity_correction_qrl, yerr=yerr_intensity_correction_qrl, color='cyan', linewidth=0., elinewidth=1.0, marker='.', label='SUMER corrected, QR-L')
ax[0].set_ylabel('Intensity correction\n HRTS/SUMER (%)', color='black', fontsize=16)
ax[1].errorbar(x=percentage_list, xerr=percentage_unc_list, y=v_peak_uncorrected_list, yerr=ev_peak_uncorrected_list, color='black', linewidth=0., elinewidth=1.0, marker='^', label='SUMER uncorrected')
ax[1].errorbar(x=percentage_list-x_shift_errorbars_percentage_log, xerr=percentage_unc_list, y=v_peak_corrected_qra_list, yerr=ev_peak_corrected_qra_list, color='blue', linewidth=0., elinewidth=1.0, marker='.', label='SUMER corrected, QR-A')
ax[1].errorbar(x=percentage_list+x_shift_errorbars_percentage_log, xerr=percentage_unc_list, y=v_peak_corrected_qrb_list, yerr=ev_peak_corrected_qrb_list, color='red', linewidth=0., elinewidth=1.0, marker='.', label='SUMER corrected, QR-B')
#ax[1].errorbar(x=percentage_list, xerr=percentage_unc_list, y=v_peak_corrected_qrl_list, yerr=ev_peak_corrected_qrl_list, color='cyan', linewidth=0., elinewidth=1.0, marker='.', label='SUMER corrected, QR-L')
ax[1].set_title(f'', fontsize=18) 
ax[1].set_xlabel(r'Percentage of maximum intensity', color='black', fontsize=16)
ax[1].set_ylabel('Doppler shift (km/s)', color='black', fontsize=16)
